...
export type PresetName = 'last7' | 'last14' | 'last30' | 'thisWeek' | 'lastWeek' | 'thisMonth' | 'lastMonth'
...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  const getPresetRange = (presetName: string): DateRange => getPresetDateRange(presetName as PresetName)
  ...
  function PresetButton({
    ...
    return (
      <Button
        className={cn(isSelected && 'pointer-events-none', 'justify-end w-full')}
        variant="ghost"
        onClick={() => {
          setPreset(preset)
      }}
  ...
  return (
    ...
    >
      ...
      <PopoverContent align={align} className="w-auto">
        <div className="flex py-2">
          <div className="flex">
            <div className="flex flex-col">
              <div className="flex flex-col lg:flex-row gap-2 px-2 justify-end items-center lg:items-start pb-4 lg:pb-0">
                {showCompare && (
              ...
              { isSmallScreen && (
                <Select defaultValue={selectedPreset} onValueChange={(value) => { setPreset(value) }}>
                  <SelectTrigger className="w-auto mx-2 mb-2">
          ...
          {!isSmallScreen && (
            ...
            <div className='flex flex-col items-end justify-between'>
              <ScrollArea className="w-42 h-50 mr-2 pr-4 **:data-[slot=scroll-area-viewport]:scroll-fade-effect-y">
                  ...
                  if (
                    ...
                    onUpdate?.({
                      ...
                      periodLabel: selectedPreset
                        ? PRESETS.find((p) => p.name === selectedPreset)?.label ?? 'Custom range'
                        : 'Custom range',
                    })
                  }
                }}
       ...
       {!!isSmallScreen && <div className="flex justify-end gap-2 py-2 pr-2">
          <Button
            onClick={() => {
              setIsOpen(false)
              resetValues()
